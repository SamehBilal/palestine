...
class CountryController extends Controller
{
    ...
    protected $rname    = 'countries';
    protected $bulk_can = 'countries_bulk';
    protected $phrases  = [
        'index'     => 'Countries',
        'trash'     => 'Trash',
        'create'    => 'Add Country',
    ...
    public function insert($request, &$model, $mod = 'create')
    {
        ...
        $model->phone_code                  = (int)$request->phone_code;
        $model->support                     = (bool)$request->support;
    ...
    public function update(UpdateCountryRequest $request, Country $country)
    {
        ...
        $model = $country;
        $this->validate($request, $this->model::rules($update = true, $country->id));
    ...
    public function destroy(Country $country)
    {
        ...
        $action = 'delete';
        if (empty($country)) {
            $country = $country->withTrashed()->firstOrFail();
            $action = Gate::allows('tags_fdelete') ? 'forceDelete' : '';
        }
        $country?->$action();
        $this->cleanCache($country);
        return back();
    }
