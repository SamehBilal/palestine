...
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-layout-mode="detached" data-topbar-color="dark" data-menu-color="dark" data-sidenav-user="true" data-bs-theme="dark" data-layout-position="fixed" data-sidenav-size="condensed" class="menuitem-active" data-theme="dark">
    <head>
        <meta charset="utf-8" />
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <div class="help-box text-white text-center">
                            ...
                            <img src="{{ asset('backend/assets/images/svg/help-icon.svg') }}" height="90" alt="Helper Icon Image" />
                                ...
                                <div class="card cta-box overflow-hidden">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img class="ms-3" src="{{ asset('backend/assets/images/svg/email-campaign.svg') }}" width="92" alt="Generic placeholder image">
                                        </div>
                                    </div>
                                    <!-- end card-body -->
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check card-radio">
                                        ...
                                        <label class="form-check-label p-0 avatar-md w-100 bg-black" for="layout-color-dark">
                                            ...
                                            <div id="topnav-color">
                                                <span class="d-flex h-100 flex-column">
                                                    <span class="bg-light-lighten d-flex p-1 align-items-center border-bottom border-primary border-opacity-25">
